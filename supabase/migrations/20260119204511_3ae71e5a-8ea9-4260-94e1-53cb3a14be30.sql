-- =====================================================
-- FIX RLS: API_CONNECTIONS - Admins see ALL
-- =====================================================
...
DROP POLICY IF EXISTS "Users and admins can view connections" ON api_connections;
...
-- =====================================================
-- FIX RLS: PATIENTS - Admins see ALL
-- =====================================================
...
DROP POLICY IF EXISTS "Users and admins can view patients" ON patients;
...
-- =====================================================
-- FIX RLS: PROCEDURES - Admins see ALL
-- =====================================================
...
DROP POLICY IF EXISTS "Users and admins can view procedures" ON procedures;
...
-- =====================================================
-- ADD: Company column to user_roles (if not exists)
-- =====================================================
